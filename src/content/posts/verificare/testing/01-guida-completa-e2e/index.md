...
I test E2E si abbandonano quando il team smette di credere ai loro fallimenti. Da quel momento la suite continua a costare tempo di CI senza produrre nessuna informazione. **Rendere i fallimenti credibili è quello che riporta i test a essere un filtro invece che un rumore da ignorare prima del rilascio**, ed è la differenza fra scoprire una regressione in pipeline e scoprirla da un cliente.
