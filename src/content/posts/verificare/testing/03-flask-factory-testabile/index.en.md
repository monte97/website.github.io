...
The specific problems with mocking C-backed libraries like `confluent_kafka` are covered in [Your Flask service is untestable](/posts/testing/unit-testing/02-mock-traps-python-flask/).
