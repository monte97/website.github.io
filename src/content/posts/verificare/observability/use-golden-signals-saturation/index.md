...
figures:
  - kind: timeline
    ...
    steps:
      - kind: "t=0:00"
        title: "heap = 100 MB"
        desc: "Nessun alert. Il leak è partito, ma la finestra di storia è ancora vuota."
      - kind: "t=2:00"
        title: "heap = 340 MB"
      ...
      - kind: "t=3:30"
        ...
        desc: "heap = 520 MB, poco sopra la metà. La proiezione a cinque minuti sfonda 1 GB, quindi la regola scatta adesso."
      - kind: "t=6:50"
