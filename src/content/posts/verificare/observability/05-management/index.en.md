...
> **Prerequisite**: The MockMart repo must be cloned and working. If you do not have it from the [previous tutorial](/en/blog/verificare/observability/04-correlation/):
> ```bash
