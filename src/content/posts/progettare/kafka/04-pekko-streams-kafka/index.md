...
figures:
  - kind: beforeAfter
    ...
    afterLabel: "Responsabilità separate"
    rows:
      - label: "Thread"
      ...
      - label: "Backpressure"
        before: "Nessuna: se il consumer a valle è lento, la mailbox cresce fino all'OutOfMemoryError"
    ...
    caption: "Un attore non dovrebbe fare I/O bloccante: è la regola da cui discendono tutti e tre gli effetti"
---
