...
- **Unit testing series** — Flask refactoring details: [Your Flask service is untestable](/posts/testing/unit-testing/02-mock-traps-python-flask/) and [Testable Flask microservices](/posts/testing/unit-testing/03-flask-factory-testabile/)
