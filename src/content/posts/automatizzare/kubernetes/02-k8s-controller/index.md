...
figures:
  - kind: flow
    ...
    caption: "Nessuno dei tre parla direttamente con l'API server a ogni giro: è questo che rende il loop sostenibile su migliaia di oggetti"
    nodes:
      - kind: "Informer"
      ...
      - kind: "Reconcile"
        ...
        desc: "Legge spec, legge status, e fa un passo verso lo stato desiderato. Deve essere idempotente, perché verra' chiamata di nuovo."
        key: true
        edge: "scrive lo status"
      - kind: "API server"
        name: "L'unica fonte di verità"
